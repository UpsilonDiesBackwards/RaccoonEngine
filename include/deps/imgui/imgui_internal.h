...
struct IMGUI_API ImGuiWindow
{
    ...
    ImS8                    HiddenFramesForRenderOnly;          // Hide the window until frame N at Draw() time only
...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::Draw() and before the next ImGui::NewFrame(), which is also illegal.
...
//#endif
    ...
    // Draw helpers (those functions don't access any ImGui state!)
